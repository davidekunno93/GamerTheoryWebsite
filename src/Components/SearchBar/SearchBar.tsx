    ...
    return (
        <div className="inputBox-container">
            <div className="inputBox" style={{ width: width ?? "" }}>
                <input onChange={(e: ChangeEvent<HTMLInputElement>) => setSearchText(e.target.value)} type="text" className="input-primary" placeholder={`${placeholder ?? 'What can we help you find?'}`} />
